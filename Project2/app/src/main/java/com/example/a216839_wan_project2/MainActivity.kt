...
import com.example.a216839_wan_project2.data.database.AppDatabase
import com.example.a216839_wan_project2.data.repository.AppointmentRepository
import com.example.a216839_wan_project2.data.repository.BmiRepository
import com.example.a216839_wan_project2.data.repository.HealthProfileRepository
import com.example.a216839_wan_project2.data.repository.SavedClinicRepository
import com.example.a216839_wan_project2.viewmodel.*
...
import com.example.a216839_wan_project2.viewmodel.HealthCentreViewModelFactory
import com.example.a216839_wan_project2.ui.theme.MySehatNowTheme
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MySehatNowTheme {
                ...
                val savedClinicRepo = SavedClinicRepository(db.savedClinicDao())
                ...
                NavHost(navController = navController, startDestination = Screen.Home.route) {
                    ...
                    composable(Screen.Home.route) {
                        HomeScreen(
                            ...
                            onNavigateToHealthCentre = { navController.navigate(Screen.HealthCentre.route) },
                            onNavigateToCommunity    = { navController.navigate(Screen.CommunityTips.route) }
                        )
                    }
                    ...
                    composable(Screen.HealthCentre.route) {
                        val healthCentreVM: HealthCentreViewModel = viewModel(
                            factory = HealthCentreViewModelFactory(application, savedClinicRepo)
                        )
                        HealthCentreScreen(
                            viewModel = healthCentreVM,
                            onBack    = { navController.popBackStack() }
                        )
                    }

                    composable(Screen.CommunityTips.route) {
                        val communityVM: CommunityTipsViewModel = viewModel()
                        CommunityTipsScreen(
