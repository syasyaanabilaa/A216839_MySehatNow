...
fun ProfileLandingScreen(
    ...
    Scaffold(containerColor = BackgroundGray) { innerPadding ->
        Column(
            ...
            // ── HERO — same gradient + style as FormHeader ─────────────────
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .height(200.dp)
                ...
                // decorative circles (same as WelcomeBannerPage)
                Box(
                    Modifier
                        .size(180.dp)
                ...
                // back button — identical to FormHeader
                IconButton(
                    onClick  = onBack,
                    modifier = Modifier
                        .padding(12.dp)
                ...
                // avatar + title at bottom-start, same layout as FormHeader
                Row(
                    modifier          = Modifier
                        .align(Alignment.BottomStart)
            ...
            // ── SECTION LABEL — same as SectionHeader in HomeScreen ────────
            Text(
                "What's included",
            ...
            // ── FEATURE CARD — same as SectionCard in HomeScreen ───────────
            Card(
                modifier  = Modifier
                    .fillMaxWidth()
            ...
            // ── PRIMARY CTA — same style as ProfileFormScreen submit button ─
            Button(
            ...
            // ── SECONDARY — same style as ProfileFormScreen cancel button ──
            OutlinedButton(
                onClick  = onBack,
                modifier = Modifier
                    .fillMaxWidth()
...
// ── FEATURE ROW — same pattern as ExpandableServiceRow ───────────────────────
@Composable
