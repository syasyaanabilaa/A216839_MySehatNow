...
import com.example.a216839_wan_project1.ui.theme.MySehatNowTheme
...
fun PreviewProfileLanding() {
    MySehatNowTheme {
        ProfileLandingScreen(onStartSetup = {}, onBack = {})
    }
}
...
fun PreviewProfileForm() {
    MySehatNowTheme {
        ProfileFormScreen(viewModel = viewModel(), onBack = {}, onSubmit = {})
    }
}
...
fun PreviewProfilePreview() {
    MySehatNowTheme {
        ProfilePreviewScreen(viewModel = viewModel(), onEdit = {}, onHome = {})
    }
}
